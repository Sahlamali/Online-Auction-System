...
java.sql.Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/project","root","Ya1@Rahman");
...
%>
		...
		<h4><%=name%></h4>
		<h4>Rs <%=cost%>/-</h4>
		<h5>Selling Time: till 4:30pm 20-Nov-2019</h5>
	 <%}
		%>
		...
		session.setAttribute("myId",sid);	//Pass the id of image tonext page//
	}
...
<a href="sell.jsp" style="text-decoration:none;"><b id="linksbelow">Sell</b></a>
<a href="bid.jsp" style="text-decoration:none;"><b id="linksbelow">Show bid amounts</b></a>
<br>
<br>
</center>